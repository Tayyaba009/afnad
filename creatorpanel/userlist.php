    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box"><!-- /.box-header -->
                <div class="box-body">
<a href="javascript:;" onclick="showAjaxModal('user-add.php?cmd=<?=$_GET['cmd']?>');" 
    class="btn btn-primary pull-right">
        ...
        Add New </a>
            ...
            <ul class="dropdown-menu dropdown-default pull-right" role="menu">
              ...
              <li> <a href="#" onclick="showAjaxModal('user-add.php?id=<?=$row['id']?>&cmd=<?=$_GET['cmd']?>');"> <i class="entypo-pencil"></i> Edit </a> </li>
